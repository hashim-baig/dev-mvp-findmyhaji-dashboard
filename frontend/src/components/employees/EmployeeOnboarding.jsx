...
const EmployeeOnboarding = () => {
  ...
  // const steps = [
  //   { id: 1, title: 'Employee Info', subtitle: 'Give employee\'s basic info', nextStep: 'Set Permissions' }
  ...
  const handleSubmit = async() => {
    try{
        ...
        const response = await Network.post(Urls.baseUrl +'/users/register', headers, form);
